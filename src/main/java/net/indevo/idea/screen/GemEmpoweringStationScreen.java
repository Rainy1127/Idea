package net.indevo.idea.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import net.indevo.idea.Idea;
import net.indevo.idea.screen.renderer.EnergyDisplayTooltipArea;
import net.indevo.idea.screen.renderer.FluidTankRenderer;
import net.indevo.idea.util.MouseUtil;
...
public class GemEmpoweringStationScreen extends AbstractContainerScreen<GemEmpoweringStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Idea.MOD_ID,"textures/gui/gem_empowering_station_gui.png");
